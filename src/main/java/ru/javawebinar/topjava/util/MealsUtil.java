...
public class MealsUtil {
    ...
    public static final List<Meal> meals = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 13, 0), "2: Обед", 1000),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 30, 20, 0), "1: Ужин", 500),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 0, 0), "2: Еда на граничное значение", 100),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 10, 0), "1: Завтрак", 1000),
            new Meal(LocalDateTime.of(2020, Month.JANUARY, 31, 13, 0), "2: Обед", 500),
